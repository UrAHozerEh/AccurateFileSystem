...
namespace AccurateReportSystem.AccurateDrawingDevices
{
    public abstract class AccurateDrawingDevice
    {
        ...
        public abstract void DrawLine(double x1, double y1, double x2, double y2, Color color, float opacity = 1);
        public abstract void DrawLine(double x1, double y1, double x2, double y2, double thickness, Color color, float opacity = 1);
